...
function ForbiddenPage() {
  return (
    <div className="relative flex min-h-svh w-full flex-col items-center justify-center overflow-hidden bg-background px-6 py-12">
      ...
      <div className="pointer-events-none absolute top-1/3 left-1/4 h-72 w-72 animate-pulse rounded-full bg-red-500/5 blur-3xl dark:bg-red-400/5" />
      <div className="pointer-events-none absolute right-1/4 bottom-1/4 h-64 w-64 rounded-full bg-rose-500/5 blur-3xl [animation:pulse_4.5s_ease-in-out_infinite] dark:bg-rose-400/5" />

      <div className="relative z-10 flex flex-col items-center text-center">
        {/* Lock icon with shake animation */}
        <div className="relative mb-6">
          <div className="absolute inset-0 animate-ping rounded-full bg-red-500/10 [animation-duration:3s]" />
