  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground p-3 font-sans">
        <div className="max-w-md w-full bg-card border border-border rounded-xl p-4 shadow-2xl flex flex-col gap-4">
          ...
          <div className="bg-zinc-950 border border-zinc-800/80 rounded-lg p-2 font-mono text-xs text-zinc-300 flex flex-col gap-2">
