...
export type DeleteWorkflowRunData = {
    ...
    query?: never;
    url: '/api/automa/workflows/runs/{run_id}';
};
...
export type DeleteAllWorkflowRunsData = {
    body?: never;
    path: {
        id: string;
    };
...
export type DeleteAllWorkflowRunsResponses = {
    /**
     * All runs for workflow deleted successfully
     */
    200: unknown;
};
